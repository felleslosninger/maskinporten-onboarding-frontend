...
import { Button, Textfield, Modal } from "@digdir/designsystemet-react";
...
const ConfirmAlert = React.forwardRef<HTMLDialogElement, Props>(
  (props, ref) => {
        ...
        <Modal.Footer>
          <div className={styles.buttonRow}>
            <Button color={"danger"} onClick={validateAndConfirm}>
              Bekreft
              <VisuallyHidden>sletting</VisuallyHidden>
            </Button>
            <Button
              variant={"secondary"}
