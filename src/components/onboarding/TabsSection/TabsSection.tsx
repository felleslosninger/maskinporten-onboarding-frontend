...
function TabsSection() {
        ...
        return (
            <>
                <div className={styles.configHeader}>
                    ...
                    <ToggleButtonGroup items={items} onChange={(value) => setSelectedConfig(value)} />
                </div>
        ...
        <>
            ...
            <InfoBox>
                ...
                <ol className={`${styles.bottomSpacing} ${styles.orderedList}`}>
                    ...
                    <li>
                        Det er opprett en {link("/dashboard", "ny integrasjon ")} eller en eksisterende integrasjon som du ønsker å gjenbruke
                ...
                <ol className={styles.orderedList}>
                    <li>Lag JWT-grant i henhold til {link("https://docs.digdir.no/docs/Maskinporten/maskinporten_protocol_jwtgrant","standarden")}. Følgende felter er påkrevd</li>
                        <ol>
                            ...
                            <li>Bodyfeltet <code>iss</code>: client-id for integrasjonen du ønsker å bruke</li>
                    ...
                    <li>POST med content-type <code>application/x-www-form-urlencoded</code> til Maskinporten sitt token-endepunkt* og følgende parametre i body
                        <ol>
                    ...
                    <li>Gjør en kall til API-tjenesten med innholdet i <code>access_token</code> som en del av http-headeren: <code>Authentication: Bearer accesstoken-verdi</code> </li>
                </ol>
    ...
    const keySection = () => (
        <>
            ...
            <Paragraph spacing>
                Her lager du ditt eget asymmentriske nøkkelpar. Når du oppretter en ny integrasjon, legger du
                ved public-nøkkelen du ønsker å bruke. Du får en key id (kid) som du kan referer til som en del
            ...
            <InfoBox>
                ...
                <ol className={`${styles.bottomSpacing} ${styles.orderedList}`}>
                    ...
                    <li>
                        API-tilgangen er gitt til din virksomhet av organisasjonen som tilbyr API'et. Når dette er gjort
                        vil du se tilgangen i {link("/dashboard", "oversikten")}.
                    </li>
                    <li>
                        Du har opprettet et asymmentrisk nøkkelpar av typen RSA256 og har public-delen av nøkkelen tilgjengelig.
                        Om du ikke har et eksisterende nøkkelpar kan du opprette et med kommandoene
                        <ol>
                            <li><code>openssl genrsa -out maskinporten.pem 2048</code></li>
                            <li><code>openssl rsa -in maskinporten.pem -pubout -out maskinporten.pub</code>henter ut
                                public-delen til fila maskinporten.pub </li>
                        </ol>
                    </li>
                    <li>
                        Det er opprett en {link("/dashboard", "ny integrasjon ")} eller en eksisterende integrasjon som du
                        ønsker å gjenbruke et eksisterende nøkkelsett. Dersom du oppretter ny integrasjon, last opp public-delen av
                        nøkkelen du ønsker å bruke ved opprettelse.
                    </li>
                </ol>
                <Heading size={"medium"}>
                    Fremgangsmåte
                ...
                <ol className={styles.orderedList}>
                    ...
                    <ol>
                        <li>Headerfeltet <code>alg</code>: RS256, RS384 eller RS512 er mulige verdier støttet av Maskinporten</li>
                        <li>Headerfeltet <code>kid</code>: key-id (kid) fra integrasjonen du ønsker å bruke</li>
                        <li>Bodyfeltet <code>aud</code>: Maskinporten-url*</li>
                        <li>Bodyfeltet <code>iss</code>: client-id for integrasjonen du ønsker å bruke</li>
                        <li>Bodyfeltet <code>scope</code>: scopet knyttet til apiet du vil aksessere</li>
                        <li>Bodyfeltet <code>ita</code>: Timestamp i UTC-tid</li>
    ...
    const otherSection = () => (
        <>
            ...
            <Paragraph spacing>
                ...
                selvbetjenings-API. Dette gir mulighet for å automatisere inn- og utmelding av integrasjoner,
            ...
            <Paragraph spacing>
                Dersom du kun ønsker å ha <strong>ett</strong> gyldig virksomhetssertifikat å signere med for hver integrasjon, støtter vi dessverre ikke
