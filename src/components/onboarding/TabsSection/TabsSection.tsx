        ...
        <>
            ...
            <InfoBox>
                ...
                <ol className={`${styles.paragraph} ${styles.orderedList}`}>
                    ...
                    <li>
                        Det er opprett en {link("/dashboard", "ny klient ")} eller en eksisterende klient som du
                        ønsker å gjenbruke et eksisterende nøkkelsett. Dersom du oppretter ny klient, last opp public-delen av
